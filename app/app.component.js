System.register(['angular2/core', 'angular2/router', 'angular2/http', './home/home.component', './login/login.component', './register/register.component', './tests/tests.component', './create-test/create-test.component', './test/test.component', './highscores/highscores.component', './user/user.component', './services/user.service'], function(exports_1) {
    ...
    var core_1, router_1, http_1, home_component_1, login_component_1, register_component_1, tests_component_1, create_test_component_1, test_component_1, highscores_component_1, user_component_1, user_service_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
